# SpectrumShaderLanguage [![Build Status](https://travis-ci.org/SpectrumLib/SpectrumShaderLanguage.svg?branch=cleanup)](https://travis-ci.org/SpectrumLib/SpectrumShaderLanguage) CLEANUP
